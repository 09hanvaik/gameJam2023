...
// collision blocks
const parsedCollisions = collisionsLevel1.parse2D() //set to the singular room its on currently // info from utils.js
...
const backgroundLevel1 = new Sprite({
    ...
    imageSrc: "assets/img/room1.png" // current background image is set here
})
